...
//             ),
//         home: About(variable: _type));
//   }
// }

class About extends StatefulWidget {
  // const About({Key? key}) : super(key: key);
  // About({Key? key, required this.variable}) : super(key: key);
  // String? variable;
  About({Key? key, required this.token}) : super(key: key);
  String? token;
  // String? variable;
          ...
          Container(
              ...
              child: TextButton(
                  onPressed: () {
                    ...
                    //       MaterialPageRoute(
                    //           builder: (context) =>
                    //               EmployeeDashboard(token: widget.token)));
                    // }
                    Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
